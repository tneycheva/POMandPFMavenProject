...
public class SearchFieldTestsByObject {
    ...
    public Object[][] searchUsers() {
        return new Object[][]{
                {"MARIELKATA", "http://training.skillo-bg.com:4300/users/32"}
        };
    }
    ...
    public void testSearchFieldOnProfilePage(String user, String profileUrl) {
        ...
        loginPage.populateUsername("teddy");
        ...
        Assert.assertEquals(actualUserName, "teddy", "The username is incorrect!");
